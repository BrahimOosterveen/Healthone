...
<main>
    <article>
        ...
        $sql = "SELECT artsid, naam, achternaam, adres, telefoonnummer, specialiteit FROM artsen WHERE id=" . $_GET['id'];
        ...
        if($result = mysqli_query($conn, $sql)){
            if(mysqli_num_rows($result) > 0){
                ...
                echo "<th scope=\"col\">specialeit</th>";
                echo "</tr>";
                echo "</thead>";
        ...
        <form>
            ...
            <thead>
                ...
                <td> <input type="text" name="bedrag" value="<?php echo $naam; ?>"></td>
                <td> <input type="text" name="bedrag" value="<?php echo $naam; ?>"></td>
                <td> <input type="text" name="bedrag" value="<?php echo $naam; ?>"></td>
                <td> <input type="text" name="bedrag" value="<?php echo $naam; ?>"></td>
                <td> <input type="text" name="bedrag" value="<?php echo $naam; ?>"></td>
