...
<main>
    <article>
        ...
        //echo "<td> <form method='post'> <input type='submit' name='aanpas' value='Aanpassen'></form>" . "</td>";
        if($result = mysqli_query($conn, $sql)){
            if(mysqli_num_rows($result) > 0){
                ...
                if(isset($_POST['aanpas'])){
                    $query = $conn->prepare("UPDATE patient SET naam = 'naam', achternaam = 'achternaam' , telefoonnummer, 'tel'");
                    $query->execute();
                }
